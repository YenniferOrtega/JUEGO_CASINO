...
public class MENU extends javax.swing.JFrame {
    ...
    private void BOTRAGAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BOTRAGAActionPerformed
        JOptionPane.showMessageDialog(null, "Selecciono la opcion de tragamonedas"
                + "\n" + "!A JUGAR¡", "CASINO ECCI", JOptionPane.PLAIN_MESSAGE, new ImageIcon("src/tragamonedas2.gif"));
